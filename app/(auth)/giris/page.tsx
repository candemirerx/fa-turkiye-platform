      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        {!showEmailForm ? (
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-gray-100 text-gray-700 px-6 py-4 rounded-lg font-medium hover:bg-gray-200 transition-all focus:outline-none focus:ring-4 focus:ring-blue-500"
          >
            <Mail className="w-6 h-6" />
            <span className="text-lg">Email ile Devam Et</span>
          </button>
        ) : (
